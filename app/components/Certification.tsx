  ...
  return (
    <div className="container mx-auto px-6 md:px-12">
      <div className="mt-20 text-center">
        <p className="text-xl font-bold text-white opacity-60">
          Celebrating learning, service, and teamwork
        </p>

        <div className="group inline-block text-center">
          <h3 className="mb-8 text-xl font-semibold text-white md:text-4xl">
        ...
        {achievements.map((achievement, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              <h4 className="max-w-[70%] text-lg font-semibold text-white">
                {achievement.title}
              </h4>

              <span className="rounded-full bg-white/5 px-3 py-1 text-xs uppercase tracking-widest text-[#13adc7]">
                {achievement.date}
              </span>
            </div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-[#e2e8f0] md:text-base">
